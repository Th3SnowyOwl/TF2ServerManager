...
curl -O https://sm.alliedmods.net/smdrop/1.11/sourcemod-1.11.0-git6906-windows.zip
...
powershell -command "Expand-Archive \"C:\servers\hlserver\tfserver\tf\sourcemod-1.11.0-git6906-windows.zip\" \"C:\servers\hlserver\tfserver\tf\""
del Metamod.zip
del Sourcemod.zip
